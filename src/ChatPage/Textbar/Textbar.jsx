...
const TextBar = ( {handleSend,setPrompt} ) => {
    return(
            <div className="flex flex-col items-center absolute bottom-5 left-[50%] translate-x-[-50%] p-2 justify-center bg-[var(--background-Secondary)] w-[35%] rounded-2xl">
                ...
                <div className="flex w-full gap-2 mt-2">
                    <button className="border p-1.5 text-[#7a7e7d] border-[#7a7e7d] rounded">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
