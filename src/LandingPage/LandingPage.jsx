                ...
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    ...
                    <div className="flex-shrink-0 w-[200px] ">
                        <a href="#" className="-m-1.5 p-1.5 flex items-center">
                            ...
                            <span className="text-2xl font-semibold">ChatAI</span>
                        </a>
                    </div>
                        ...
                        <div className="hidden lg:flex lg:gap-x-10">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className="text-sm/6 border-b-2 border-transparent transition duration-150 hover:border-[var(--color-primary)] font-semibold text-[var(--color-primary)]"
                                >
                                    {item.name}
                                </a>
                            ))}
                    ...
                    <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="-m-2.5 rounded-md p-2.5 text-[var(--color-third)]"
                            >
